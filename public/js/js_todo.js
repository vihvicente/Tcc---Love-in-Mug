...
loadTodos();
    ...
    function addTask() {
        ...
        // Verifique se a tarefa não está vazia
        if (task.trim() !== '') {
            // Crie um novo elemento para a tarefa
            ...
            taskItem.innerHTML = `
                ...
                <button class="mark-button" onclick="markTaskAsDone(this)">Concluir</button>
            `;
    ...
    function editTask(button) {
        ...
        var taskText = taskItem.querySelector('p').textContent;
        var newTask = prompt('Editar tarefa:', taskText);
        if (newTask !== null) {
